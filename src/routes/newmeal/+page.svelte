<script lang="ts">
  ...
  function handleContinue() {
    ...
    sessionStorage.setItem('addedMeals', JSON.stringify(contextState.addedMeals));
  ...
  onMount(()=>{
    ...
    contextState.addedMeals = JSON.parse(sessionStorage.getItem('addedMeals') || '[]');
  })
</script>
  ...
  <div class="space-y-4">
    ...
    >
      ...
      <div class="text-center">
        ...
        <p class="text-sm text-gray-500 mt-1">Scan the QR code on your meal packaging.</p>
      </div>
    </button>
    ...
    >
      ...
      <div class="text-center">
        <h2 class="text-lg font-semibold text-gray-900">Don't have your QR codes yet?</h2>
        <p class="text-sm text-gray-500 mt-1">Generate your own and apply them to your meals.</p>
      </div>
    </button>

    <p class="text-gray-700 mt-8"><span class="font-bold">{contextState.addedMeals.length}</span> added</p>
