...
<footer class="footer bg-gray-50 text-base-content p-10">
	...
	<nav>
	  ...
	  <a href="/dashboard#dashboard_nav" class="link link-hover">Dashboard</a>
  ...
  <footer class="footer bg-gray-50 text-base-content border-base-300 border-t px-10 py-4">
	<aside class="grid-flow-col items-center">
	  <img src="/main_logo.png" alt="OneMoreMeal" class="size-8" />
	  <p>
		OneMoreMeal
		<br />
		Serve someone else.
